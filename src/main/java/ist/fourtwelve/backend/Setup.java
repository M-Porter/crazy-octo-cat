    ...
    public void compileRunProjects(){
        ...
        for(int i = 0; i < projects.size(); i++) {
            ...
            for(int j = 0; j < temp.getTestRuns().size(); j++){
                ...
                //TODO: Add in a way to put test arguments not from the text file -- Inputs done.
                //TODO: Change the way RunJava handles the arguments. Should be something from the simple test case.
                //TODO: Success needs to be changed in the project when the stuff below
                //TODO: Way to get around unzipping is to unzip and then just move the damned files where they need to go.
